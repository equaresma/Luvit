...
function configureStore(history, initialState /*?: ApplicationState*/) {
    var reducers = {
    ...
    var rootReducer = redux_1.combineReducers(__assign(__assign({}, reducers), { router: connected_react_router_1.connectRouter(history) }));
    var enhancers = [];
