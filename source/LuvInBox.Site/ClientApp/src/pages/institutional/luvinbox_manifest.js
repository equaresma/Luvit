        ...
        <div>
            <div className="row">
                ...
                <div className="col-6 blackBox">
                    <section>
                        <h1 className="font_5">
                            Comprar na<br /><span className="luvInBoxName">LUV IN BOX</span> é ajudar
                            </h1><br />
                        <p>
            ...
            <div className="row">
                <div className="col-12">
                    <section>
                        <div className="row silverBoxMin">
                            <div className="col-12 divCenter" style={{ marginTop: "40px" }}>
                                <h1>Todos os dias, no Brasil</h1>
                                <p>Informar é conscientizar</p>
                            </div>
                        </div>
                        <div className="row silverBox">
                            <div className="col-4 divCenter">
                                <h1>+800</h1>
                                <p>mulheres são estupradas</p>
                            </div>
                            <div className="col-4 divCenter">
                                <h1>50%</h1>
                                <p>são crianças, com até 13 anos de idade</p>
                            </div>
                            <div className="col-4 divCenter">
                                <h1>+230</h1>
                                <p>denúncias de violência doméstica são registradas</p>
                            </div>
                        </div>
                    </section>
                </div>
            </div>
            <div className="row pinkBox">
            ...
            <div className="row">
                <div className="col-12 amarelinhaBox">
            ...
            <div className="row">
                <div className="col-12 dancarinaBox">
                    <section>
                        <div>
                            <h1 className="font_5">
                                Porque comprar na <span className="luvInBoxName">LUV IN BOX</span><br />é tudo de bom?
                            </h1>
                            <br />
                        </div>
            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="row">
                        <div className="col-1 blackBelt">
                            <div className="textRot">Saiba como...</div>
                        </div>
                        <div className="col-11">
                            <section>
                                ...
                                <div className="row">
                                    <div className="col-6 lightGrayBox">
                                        <i className="pi pi-star" style={{ fontSize: "1.5rem", color: "yellow" }}></i>
                                        <h2>Seja um voluntário</h2><br />
                                        <p>
                                            Conheça as ONG's e OSCIP's parceiras do programa, no Brasil, e seja um voluntário.
                                        </p>
                                    </div>
                                    <div className="col-6 lightGrayBox">
                                        <i className="pi pi-money-bill" style={{ fontSize: "1.5rem", color: "darkGreen" }}></i>
                                        <h2>Doe</h2><br />
                                        <p>
                                            Apoie ainda mais esse projeto doando online e com segurança, diretamente para as ONG's e OSCIP's parceiras.
                                        </p>
                                    </div>
                                </div>
                            </section>
